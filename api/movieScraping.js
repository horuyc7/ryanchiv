...
module.exports = async (req, res) =>{
        try {
          const browser = await puppeteer.launch({
            executablePath: '/Users/horuy/.cache/puppeteer/chrome/mac_arm-122.0.6261.69/chrome-mac-arm64/Google Chrome for Testing.app/Contents/MacOS/Google Chrome for Testing'
          });
